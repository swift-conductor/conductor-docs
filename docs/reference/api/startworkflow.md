...
| input                           | JSON object with key value params, that can be used by downstream tasks                                                                   | See [Wiring Inputs and Outputs](../../documentation/configuration/workflowdef/index.md#wiring-inputs-and-outputs) for details |
...
| workflowDef                     | An adhoc [Workflow Definition](../../documentation/configuration/workflowdef/index.md) to run, without registering. See [Dynamic Workflows](#dynamic-workflows). | optional                                                                                                |
